...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/PYK888/YKNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'PYK888' => 'pengyingke@qq.com' }
  s.source           = { :git => 'https://github.com/PYK888/YKNetworking.git', :tag => s.version.to_s }
